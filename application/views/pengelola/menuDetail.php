 <?php
    ...
    $queryKoment = $this->db->query("SELECT * FROM komentar where id_menu = '$id_menu'")->result(); ?>
                                 ...
                                 <div class="row">
                                     <div class="col-md-12">
                                         ...
                                         <div class="card card-widget">
                                             ...
                                             <!-- /.card-header -->
                                             <div class="card-body">
                                                 <img style="height: 400px; width: 100%" class="img-fluid pad"
                                                     src="<?php echo base_url('upload/') ?>menu/<?php echo $menu['foto'] ?>"
                                                     alt="Photo">
                                                 <h4 class="text-center font-weight-bold mt-3">
                                                     <?php echo $menu['nama_menu'] ?></h4>
                                                 <h4 class="font-weight-bold mt-3">

                                                     <p>Harga :<?php echo $menu['harga'] ?></p>
                                                 </h4>

                                                 <p><?php echo $menu['detail'] ?></p>
                                                 <?php
                                                        $id_menu = $menu['id_menu'];
                                                        $queryJumlah = $this->db->query("SELECT count(id_komentar) as jumlah_komentar from komentar where id_menu = $id_menu")->row_array(); ?>
                                                 <span
                                                     class="float-right text-muted"><?php echo $queryJumlah['jumlah_komentar'] ?>
                                                     comments</span>
                                             </div>
                                             <!-- /.card-body -->
                                                 ...
                                                 <div class="card-comment">
                                                     ...
                                                     <div class="comment-text">
                                                         <span class="username">
                                                             ...
                                                             <span
                                                                 class="text-muted float-right"><?php echo date('d M Y', strtotime($value->tanggal_komentar)) ?></span>
                                                         </span><!-- /.username -->
                                                     ...
                                                     <div class="balas ml-5 mt-2 mb-2">
                                                         ...
                                                         <div class="comment-text">
                                                             <span class="username">
                                                                 balasan anda
                                                                 <span
                                                                     class="text-muted float-right"><?php echo date('d M Y', strtotime($value2->tanggal_balasan)) ?></span>
                                                             </span><!-- /.username -->
                                                             <?php echo $value2->balas_komen ?>
                                                         </div>
                                                         <?php endforeach ?>
                                                         <form
                                                             action="<?php echo base_url('pengelola/balasKomentar/' . $menu['id_menu'] . '/' . $value->id_komentar) ?>"
                                                             method="post" class="mt-2">
                                                             <div class="input-group input-group-sm">
                                                                 <input type="text" class="form-control form-control-sm"
                                                                     name="balas" placeholder="balas komentar">
                                                                 <span class="input-group-append">
                                                                     <button type="submit"
                                                                         class="btn btn-info btn-flat">Balas</button>
                                                                 </span>
                                                             </div>
                                                         </form>
                                                     </div>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="file" class="form-control" id="inputSkills" name="foto"
                                                 placeholder="nama ketua" value="<?php echo $menu['foto'] ?>">
                                         </div>
                                     </div>
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <textarea class="textarea" name="deskripsi"
                                                 ...
                                                 style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $menu['harga']; ?></textarea>
                                         </div>
                                     </div>
                                     <div class="form-group row">
                                         <div class="offset-sm-2 col-sm-10">
                                             <button type="submit" class="btn btn-danger"><i
                                                     class="far fa-plus mr-1"></i>Edit</button>
                                         </div>
                                     </div>
                                 </form>
                             </div>
