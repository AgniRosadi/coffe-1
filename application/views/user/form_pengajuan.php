      ...
      <div class="card" style="background-color: #0F0F11; border-color: white" >
        <div class="container" >
          <div class="row">
            ...
            <div class="col-lg-8">
              <br>
              <form action="<?php echo base_url('user/insertPengajuan') ?>" method="POST" enctype="multipart/form-data">
                 <div class="form-group">
                  <input type="" value="<?php echo $kode ?>" class="form-control" id="" name="password" >
                </div>
                <div class="form-group">
            ...
            <div class="col-lg-3 offset-lg-1">
              ...
              <div class="media contact-info">
                ...
                <div class="media-body">
                  <p>Email konfirmasi persetujuan akan dikirim dengan jangka waktu 3-5 hari setelah mendaftar.</p>
                </div>
              </div>
              <div class="media contact-info">
                <span class="contact-info__icon"><i class="fab fa-btc"></i></span>
                <div class="media-body">
                  <p>Apabila sudah mendapat email konfirmasi pemilik caffe akan diberikan link untuk mengelola data caffenya</p>
                </div>
              </div>
            </div>
          </div>
