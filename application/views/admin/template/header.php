        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <?php if (!$this->session->userdata('role_id')) { ?>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url('pengelola/kelolaCafe') ?>" class="nav-link <?php echo $side == 'kelola' ? 'active' : '' ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('dashboard/kelolaCafe') ?>" class="nav-link <?php echo $side == 'cafe' ? 'active' : '' ?>">
